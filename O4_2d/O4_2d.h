...
public:
  ...
  O4(int Nx, int Ny, bool xperiodic, bool yperiodic, bool pi_flux, double a1, double a2, double a3, double a4, double U, double cutoff): Nx(Nx), Ny(Ny), xperiodic(xperiodic), yperiodic(yperiodic), pi_flux(pi_flux), a1(a1), a2(a2), a3(a3), a4(a4), U(U), cutoff(cutoff) {};
  
  MPO O4Hamiltonian();
  AutoMPO BondHamiltonian(AutoMPO&, int, int, int);
};
